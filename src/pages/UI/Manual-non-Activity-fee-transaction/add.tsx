...
function DesignerManualNonActivityFeeTransactionAdd() {
            ...
            <div className="title-block">
              <div className="left-block">
                <Typography variant={"h2"} className="pb-0">
                  Manual Non Activity Fee Transaction
                </Typography>
              </div>
            </div>
              ...
              <Grid spacing={3} container>
                ...
                <Grid item xs={12} md={6} lg={4}>
                  <div className="input-with-label date-select-input">
                    <label className="lg">Transaction Date<span className="required-field">*</span></label>
                    <FormControl fullWidth>
                ...
                <Grid item xs={12} md={6} lg={4}>
                  <div className="input-with-label">
                    <label className="lg">
                      Transaction Amount<span className="required-field">*</span>
                    </label>
                    <FormControl fullWidth>
                ...
                <Grid item xs={12} md={6} lg={4}>
                  <div className="input-with-label">
                    <label className="lg">Currency<span className="required-field">*</span></label>
                    <FormControl fullWidth>
                    <Select
                        value={selectVal}
                        onChange={handleChange}
...
export default DesignerManualNonActivityFeeTransactionAdd;
